...
import '../../controller/health_disclosure_controller.dart';
import '../../data/esthetician_models.dart';

/// Screen displaying health disclosures
class HealthDisclosuresScreen extends StatelessWidget {
  const HealthDisclosuresScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(HealthDisclosureController());
      ...
      body: Obx(() {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            final disclosure = disclosures[index];
            return _DisclosureCard(disclosure: disclosure);
          },
        );
      }),
    );
...
class _DisclosureCard extends StatelessWidget {
  final HealthDisclosure disclosure;
                ...
                children: [
                  CircleAvatar(
                    ...
                    child: Icon(
                      ...
                      color: hasAlert ? Colors.red : Colors.teal,
                      size: 20,
                    ),
                  ),
