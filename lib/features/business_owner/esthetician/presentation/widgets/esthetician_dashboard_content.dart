...
import '../screens/health_disclosures_screen.dart';
import '../screens/treatment_notes_screen.dart';
import '../screens/retail_products_screen.dart';

/// Esthetician Dashboard Content Widget 🧖
class EstheticianDashboardContent extends StatefulWidget {
  const EstheticianDashboardContent({super.key});

  @override
  State<EstheticianDashboardContent> createState() =>
      _EstheticianDashboardContentState();
}

class _EstheticianDashboardContentState
    extends State<EstheticianDashboardContent> {
  late final EstheticianDashboardController dashboardController;
  ...
  void initState() {
    ...
    if (shopId != null && shopId > 0) {
      ...
      portfolioController.fetchPortfolioItems(niche: 'esthetician');
    }
  }
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Disclosure Alerts Card (KEY FEATURE)
  ...
  Future<void> _refreshAll() async {
    await Future.wait([
      ...
      revenueController.fetchRevenue(forNiche: 'esthetician'),
    ]);
  }
      ...
      return Container(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.people, color: Colors.teal[600], size: 20),
            ...
            Row(
              children: [
                Icon(Icons.shopping_bag, color: Colors.teal[600], size: 20),
                const SizedBox(width: 8),
                Expanded(
                  child: Text(
                    '${dashboard?.retailProductsCount ?? 0} Products',
                    style: const TextStyle(fontWeight: FontWeight.w600),
                    overflow: TextOverflow.ellipsis,
                  ),
                ),
  ...
  /// Disclosure Alerts Card - Red badge, top 3 clients
          ...
          children: [
            ...
            if (count > 3) ...[
              ...
              Center(
                child: TextButton(
                  onPressed: () =>
                      Get.to(() => const HealthDisclosuresScreen()),
                  child: Text(
                    'View All ($count)',
  ...
  Widget _buildAlertItem(DisclosureAlert alert) {
    return InkWell(
      onTap: () => Get.to(() => const HealthDisclosuresScreen()),
      child: Container(
  ...
  Widget _buildQuickLinksGrid() {
    final links = [
      _QuickLink(
        ...
        label: 'Skin Profiles',
        color: Colors.teal,
        onTap: () => Get.to(() => const ClientSkinProfilesScreen()),
      ),
      _QuickLink(
      ...
      _QuickLink(
        ...
        label: 'Products',
        color: Colors.purple,
        onTap: () => Get.to(() => const RetailProductsScreen()),
      ),
    ];
  ...
  Widget _buildRecentTreatmentNotes() {
    return Obx(() {
      ...
      return _buildSection(
        ...
        action: 'View All',
        onAction: () => Get.to(() => const TreatmentNotesScreen()),
        child: Column(
          children: notes
              .take(3)
              .map(
                ...
                .map(
                  (b) => ListTile(
                    leading: CircleAvatar(
                      backgroundColor: Colors.teal[100],
                      child: Text(
                        (b.userName != null && b.userName!.isNotEmpty)
