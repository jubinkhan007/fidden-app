...
class AllBookingListScreen extends StatelessWidget {
  const AllBookingListScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<BusinessOwnerController>();
    return Scaffold(
      appBar: AppBar(title: Text('Booking List'), centerTitle: true),
