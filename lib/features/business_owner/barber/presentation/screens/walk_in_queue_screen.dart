...
class WalkInQueueScreen extends StatelessWidget {
              ...
              Expanded(
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _buildQueueCard(entry, controller);
                  },
                ),
              ),
            ],
  ...
  Widget _buildQueueCard(WalkInEntry entry, WalkInController controller) {
    Color statusColor;
    String statusText;
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // Action buttons
            if (entry.status == WalkInStatus.waiting || entry.status == WalkInStatus.in_service)
              Padding(
                    ...
                    if (entry.isWaiting) ...[
                      Expanded(
                        child: OutlinedButton.icon(
                          onPressed: () => controller.callCustomer(entry.id),
                    ...
                    if (entry.isBeingServed) ...[
                      Expanded(
                        child: ElevatedButton.icon(
                          onPressed: () => controller.completeService(entry.id),
                ...
                child: Obx(() => ElevatedButton(
                  onPressed: controller.isSubmitting.value
                      ...
                      : () async {
                          ...
                          final success = await controller.addToQueue(
                            customerName: nameController.text.trim(),
                            customerPhone: phoneController.text.trim().isNotEmpty 
